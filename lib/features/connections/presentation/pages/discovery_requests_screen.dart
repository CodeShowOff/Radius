...
class DiscoveryRequestsScreen extends StatefulWidget {
  ...
  @override
  State<DiscoveryRequestsScreen> createState() =>
      _DiscoveryRequestsScreenState();
}

class _DiscoveryRequestsScreenState extends State<DiscoveryRequestsScreen>
      ...
      builder: (context, state) {
        ...
        if (requests.isEmpty) {
          return const _EmptyState(
            ...
            message:
                'Requests you\'ve sent via username search\nthat are waiting for a response will appear here.',
          );
        }
