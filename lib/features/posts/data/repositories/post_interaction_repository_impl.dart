...
/// Firestore-backed implementation of [IPostInteractionRepository].
class PostInteractionRepositoryImpl implements IPostInteractionRepository {
  final PostInteractionService _service;

  PostInteractionRepositoryImpl({required PostInteractionService service})
      : _service = service;
