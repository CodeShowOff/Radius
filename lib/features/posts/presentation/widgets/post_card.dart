    ...
    return ListTile(
      ...
      subtitle: Row(
        children: [
          ...
          const SizedBox(width: 4),
          Icon(
            visibility == PostVisibility.public ? Icons.public : Icons.group,
            size: 12,
        ...
        onSelected: (val) {
          ...
          if (val == 'vis') {
             onVisibilityChange?.call(
               visibility == PostVisibility.public ? PostVisibility.connections : PostVisibility.public
             );
          }
        },
        itemBuilder: (_) => [
          const PopupMenuItem(value: 'vis', child: Text('Change Visibility')),
