...
class _BluetoothBatteryHelpPage extends StatelessWidget {
  ...
  List<String> _oemGuidanceFor(_AndroidDeviceSummary? d) {
    ...
    if (key.contains('huawei') || key.contains('honor')) {
      return const [
        'Battery optimization: set Radius to â€œNot allowed to optimizeâ€.',
    ...
    if (key.contains('oppo') ||
      ...
      return const [
        ...
        'Battery optimization: set Radius to â€œDonâ€™t optimizeâ€ / â€œNo restrictionsâ€.',
      ];
    }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'Some Android phones aggressively pause Bluetooth scanning/advertising when battery optimizations are enabled. If discovery is unreliable, set Radius to â€œUnrestrictedâ€ / â€œNo restrictionsâ€ and disable app sleep features.',
                  ),
                  const SizedBox(height: 12),
