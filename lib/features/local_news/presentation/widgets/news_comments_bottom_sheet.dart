...
/// Comments bottom sheet for local news posts.
///
/// Uses [NewsInteractionCubit] for state management.
class NewsCommentsBottomSheet extends StatefulWidget {
  final String currentUserId;
  final String currentUserName;
  final String? currentUserPhotoUrl;

  const NewsCommentsBottomSheet({
    super.key,
  ...
  /// Shows the comments bottom sheet, passing the existing
  /// [NewsInteractionCubit] from the parent context.
  static void show({
  ...
  @override
  State<NewsCommentsBottomSheet> createState() =>
      _NewsCommentsBottomSheetState();
}

class _NewsCommentsBottomSheetState extends State<NewsCommentsBottomSheet> {
  ...
  void initState() {
    super.initState();
    context.read<NewsInteractionCubit>().loadComments();
  }
  ...
  void _submitComment() {
    ...
    context.read<NewsInteractionCubit>().addComment(
      ...
      builder: (context, scrollController) {
        return Column(
          children: [
            ...
            // Comments list
            Expanded(
              child: BlocBuilder<NewsInteractionCubit, NewsInteractionState>(
                buildWhen: (prev, curr) =>
